...
const OAUTH2_SALESFORCE_SANDBOX_REQUEST = 'OAUTH2_SALESFORCE_SANDBOX_REQUEST';
const OAUTH2_SALESFORCE_SANDBOX_SUCCESS_RESPONSE = 'OAUTH2_SALESFORCE_SANDBOX_SUCCESS_RESPONSE';
const OAUTH2_SALESFORCE_SANDBOX_RESPONSE_FAILURE = 'OAUTH2_SALESFORCE_SANDBOX_RESPONSE_FAILURE';

export const submit = createAsyncAction([
  OAUTH2_SALESFORCE_SANDBOX_REQUEST,
  OAUTH2_SALESFORCE_SANDBOX_SUCCESS_RESPONSE,
  OAUTH2_SALESFORCE_SANDBOX_RESPONSE_FAILURE,
...
export default createReducer(initialState, {
  [OAUTH2_SALESFORCE_SANDBOX_REQUEST]: state => ({ ...state, isFetching: true, isFailed: false, error: null }),
  [OAUTH2_SALESFORCE_SANDBOX_SUCCESS_RESPONSE]: (state, { response }) => ({ ...state, isFetching: false, ...response }),
  [OAUTH2_SALESFORCE_SANDBOX_RESPONSE_FAILURE]: (state, { error }) => ({ ...state, isFetching: false, isFailed: true, error }),
});
